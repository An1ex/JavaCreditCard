...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        CodeGenerator generator = CodeGenerator.builder().databaseUrl(JSONUtil.getByPath(ymlJson, URL_PATH).toString())
                ...
                .password(JSONUtil.getByPath(ymlJson, PASSWORD_PATH).toString()).author("anlex")
                //生成的类 放在当前模块下的
                // /target/generated-code目录底下
                .module("/CreditCard/target/generated-code").parentPackage("com.hzbank").tableName("credit_card")
                // 决定是否继承基类
...
//                .superClass(BaseController.class).enableHyphenStyle().enableRestStyle()
